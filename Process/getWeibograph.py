...
def main():
    treePath = '/Users/xiaosy/PycharmProjects/BiGCN/data/Weibo/weibotree.txt'
    ...
    labelPath = "/Users/xiaosy/PycharmProjects/BiGCN/data/Weibo/weibo_id_label.txt"
    ...
    def loadEid(event, id, y):
        ...
        if len(event) > 1:
            ...
            np_path = '/Users/xiaosy/PycharmProjects/BiGCN/data/Weibo/Weibograph/' + id + '.npz'
            np.savez(np_path, x=x_x, root=rootfeat, edgeindex=tree,
